...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    void addBook(String title, String author, int pages, int year, String publisher, String genre, double rating){
    ...
    void updateData(String row_id, String title, String author, String pages, String year, String publisher, String genre, String rating){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TITLE, title);
        cv.put(COLUMN_AUTHOR, author);
